...
class SlurmDriver:
    ...
    def generate_slurm_args(self, **kwargs) -> str:
        ...
        return "\n".join(slurm_args), output_path, error_path
    ...
    def submit_job(self, container_path: str, conda_env: Optional[str] = None, modules: List[str] = [], slurm_args: Dict[str, str] = {}) -> str:
        """
        ...
        self.create_output_directory(error_path)
    ...
    def _create_script(self, container_path: str, conda_env: Optional[str], modules: List[str], slurm_args: Dict[str, str]) -> str:
        """
        ...
        if conda_env:
            script_lines.append(f"mamba activate {conda_env}")
        if modules:
